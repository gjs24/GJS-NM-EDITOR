...
import { BoardTemplate, UserBoardValues } from '../../types/template';
import { BoardCanvas } from '../board/BoardCanvas';
import { exportBoardToPNG, exportBoardToDDS, printBoard } from '../../utils/exportUtils';
...
export const UserBoardEditor: React.FC<UserBoardEditorProps> = ({
  ...
  const { isTemplateUnlocked, openPurchaseModal } = useAuth();
  const isUnlocked = isTemplateUnlocked(activeTemplate.id, activeTemplate.isPaid);
