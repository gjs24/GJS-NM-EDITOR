...
import { BoardTemplate, BoardCategory, SavedUserBoard, UserBoardValues } from '../../types/template';
import { exportBoardToDDS, exportBoardToPNG } from '../../utils/exportUtils';
...
export const HomePage: React.FC<HomePageProps> = ({
  ...
  const { currentUser, isTemplateUnlocked, openPurchaseModal, openGoogleModal } = useAuth();
          ...
          <div className="hero-user-strip">
            {currentUser ? (
              <div className="hero-user-pill">
                <img src={currentUser.avatarUrl} alt={currentUser.name} className="hero-user-pic" />
                <div className="hero-user-details">
                  <span className="hero-user-title">
                    Logged in as <strong>{currentUser.name}</strong>
                  </span>
                  <span className="hero-user-id-tag">
                    User ID: <strong>{currentUser.userId}</strong>
                  </span>
                </div>
              ...
              <div className="hero-guest-pill">
                <div className="guest-info">
                  ...
                  <span>Sign in with Google to get your permanent <strong>User ID</strong> and keep your unlocked templates safe!</span>
                </div>
                <button type="button" className="btn-hero-google-login" onClick={openGoogleModal}>
        ...
        <section className="home-gallery-section">
          <div className="gallery-section-header">
            <div className="header-titles">
              ...
              <span className="gallery-section-sub">
                Your personal library of purchased templates and customized nameboard creations. Linked to User ID: <strong>{currentUser?.userId || 'Guest'}</strong>.
              </span>
            </div>
            ...
            <div className="my-store-unlocked-section" style={{ marginBottom: 32 }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
                ...
                <span style={{ background: 'rgba(34, 197, 94, 0.15)', color: 'var(--rail-green)', padding: '4px 10px', borderRadius: 20, fontSize: '0.75rem', fontWeight: 600 }}>
                  ✓ Unlocked for {currentUser?.userId || 'Guest'}
                </span>
              </div>
